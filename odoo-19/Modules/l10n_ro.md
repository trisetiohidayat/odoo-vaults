...
Romanian accounting chart and localization module. Manages the Accounting Chart of Accounts, VAT structure, Fiscal Position, and Tax Mapping for Romanian compliance. Also adds the Registration Number field for Romania in [[Modules/res.partner]].
...
| [[Modules/base_vat]] | Romanian CIF (Cod de Identificare Fiscala) validation |
| [[Modules/account_edi_ubl_cii]] | UBL/CII EDI framework for e-invoicing |
...
| Module | Relationship |
|--------|-------------|
| [[Modules/l10n_ro_edi]] | ANAF e-Factura EDI integration |
| [[Modules/l10n_ro_cpv_code]] | CPV product classification |
| [[Modules/l10n_ro_edi_stock]] | e-Transport (stock/inventory) |
| [[Modules/l10n_ro_edi_stock_batch]] | e-Transport batch processing |
...
4. Install [[Modules/l10n_ro_edi]] for ANAF e-Factura compliance
5. Install [[Modules/l10n_ro_cpv_code]] for product classification
...
- UBL-based EDI via [[Modules/account_edi_ubl_cii]]

## See Also

- [[Modules/l10n_ro_edi]] - Romanian ANAF e-Factura
- [[Modules/l10n_ro_cpv_code]] - CPV product classification
- [[Modules/l10n_ro_edi_stock]] - Romanian e-Transport
