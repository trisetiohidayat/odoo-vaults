...
## Chart of Accounts
Inherits chart of accounts from `[Modules/l10n_dk](l10n_dk.md)`.

## Tax Structure
Inherits tax structure from `[Modules/l10n_dk](l10n_dk.md)`.

## Fiscal Positions
Inherits fiscal positions from `[Modules/l10n_dk](l10n_dk.md)`.
