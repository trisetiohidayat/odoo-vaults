...
## Tax Structure
Basic tax templates for Bolivia. Specific rates and types configured via chart template data. Contact [Modules/l10n_latam_base](l10n_latam_base.md) for extended identification types if needed.
