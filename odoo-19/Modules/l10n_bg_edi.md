...
For Bulgarian accounting, use [Modules/l10n_bg](l10n_bg.md) which provides:
- Bulgarian Chart of Accounts
- Bulgarian VAT (ДДС) structure
- Tax reporting data
- [Modules/l10n_bg_ledger](l10n_bg_ledger.md) for extended Bulgarian ledger reporting
...
- [Modules/account_edi_ubl_cii](account_edi_ubl_cii.md) - Standard UBL/CII format for PEPPOL network
- PEPPOL network access via [Modules/account_peppol](account_peppol.md) for B2G compliance
...
1. **PEPPOL Network** (via [Modules/account_peppol](account_peppol.md)):
...
| Module | Status |
|--------|--------|
| [Modules/l10n_bg](l10n_bg.md) | Available - Bulgarian accounting |
| [Modules/l10n_bg_ledger](l10n_bg_ledger.md) | Available - Bulgarian ledger |
| `l10n_bg_edi` | **Does not exist** |

## See Also

- [Modules/l10n_bg](l10n_bg.md) - Bulgarian accounting
- [Modules/l10n_bg_ledger](l10n_bg_ledger.md) - Bulgarian ledger
