...
- [Modules/Sale](odoo-18/Modules/sale.md) — Parent `sale.order.line` model
- [Modules/sale_margin](odoo-18/Modules/sale_margin.md) — Base margin computation (`purchase_price`, `margin`, `margin_percent`)
- [Modules/sale_mrp_margin](odoo-18/Modules/sale_mrp_margin.md) — BoM-based cost for manufactured products
- [Modules/Stock](odoo-18/Modules/stock.md) — `stock.move`, `stock.valuation.layer`, `has_valued_move_ids`
- [Modules/stock_account](odoo-18/Modules/stock_account.md) — Stock valuation, average/FIFO cost computation
- [Core/API](odoo-18/Core/API.md) — `@api.depends` cascade, computed field override patterns
- [Core/Fields](odoo-18/Core/Fields.md) — `fields.Float` with `store`, `copy`, `precompute`
