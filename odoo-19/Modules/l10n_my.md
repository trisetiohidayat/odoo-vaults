...
The module establishes the foundation for Malaysia's Goods and Services Tax (GST) / Sales and Service Tax (SST) reporting structures and integrates with the [[Modules/l10n_my_edi]] module for e-invoicing.
...
| [[Modules/account_tax_python]] | Python-based tax computation |
...
- [[Modules/l10n_my_edi]] - Malaysia e-invoicing (MyInvois)
- [[Modules/l10n_my_edi_pos]] - POS e-invoicing integration
- [[Modules/l10n_my_ubl_pint]] - Malaysia UBL PINT format for Peppol
