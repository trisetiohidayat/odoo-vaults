...
The companion module [Modules/l10n_jp_ubl_pint](l10n_jp_ubl_pint.md) provides Peppol PINT JP e-invoicing. The tax report is named **Consumption Tax Report** (消費税申告書) with two main groupings: Tax Amount and Taxable Amount sections.
