...
- [[Modules/account_edi_ubl_cii]] — Base UBL BIS 3 implementation (invoices and orders)
- [[Modules/purchase]] — Purchase order model
- [[Modules/account_peppol]] — Peppol network integration (uses account_edi_proxy_client)
- [[Modules/account_edi_proxy_client]] — EDI proxy infrastructure
