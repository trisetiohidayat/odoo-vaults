...
- [Modules/Account](odoo-18/Modules/account.md) — Core accounting: journal entries, move posting, tax engine, audit trail
- [Modules/l10n_din5008](odoo-18/Modules/l10n_din5008.md) — German document layout: paperformat, letterhead standard
- [Modules/Stock](odoo-18/Modules/stock.md) — Inventory valuation, stock moves, stock accounts
...
- [Flows/Cross-Module/purchase-stock-account-flow](odoo-19/Flows/Cross-Module/purchase-stock-account-flow.md) — PO→Receipt→Vendor Bill with German VAT
