...
## Related
- [Modules/sale_project](odoo-18/Modules/sale_project.md) - SO to project/task generation
- [Modules/project_stock_account](odoo-18/Modules/project_stock_account.md) - Picking analytic moves in project profitability
