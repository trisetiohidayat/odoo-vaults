...
- [Modules/loyalty](odoo-18/Modules/loyalty.md) — Base loyalty framework (program, rule, reward, card)
- [Modules/website_sale_loyalty](odoo-18/Modules/website_sale_loyalty.md) — eCommerce-specific loyalty integration