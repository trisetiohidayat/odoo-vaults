...
- [Modules/stock_landed_costs](odoo-18/Modules/stock_landed_costs.md) — Base landed costs module (`stock.landed.cost` model)
- [Modules/mrp_subcontracting](odoo-18/Modules/mrp_subcontracting.md) — Subcontracting manufacturing orders and pickings
- [Modules/mrp_landed_costs](odoo-17/Modules/mrp_landed_costs.md) — MRP-specific landed cost views (adds `mrp_production_ids` field)
- [Modules/stock_account](odoo-18/Modules/stock_account.md) — Valuation and landed cost accounting integration
