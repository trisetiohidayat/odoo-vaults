...
Provides a pre-configured [Modules/spreadsheet_dashboard](spreadsheet_dashboard.md) template for customer service managers to track live chat performance. Data is sourced from `im_livechat.channel`, `mail.message`, and session records from [Modules/im_livechat](im_livechat.md).
