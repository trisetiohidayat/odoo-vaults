...
| Module | Relationship |
|--------|-------------|
| [Modules/auth_signup](odoo-18/Modules/auth_signup.md) | Provides the signup flow; `auth_password_policy` activates on password set during signup |
| [Modules/auth_totp](odoo-18/Modules/auth_totp.md) | Two-factor authentication; complementary to password policy |
| [Modules/base_setup](odoo-17/Modules/base_setup.md) | Provides the `res.config.settings` form layout this module injects into |
