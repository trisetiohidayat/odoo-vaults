...
- [Modules/iap_crm](odoo-17/Modules/iap_crm.md) — IAP account integration and credit management
- [Modules/crm_iap_mine](odoo-18/Modules/crm_iap_mine.md) — Industry/role/seniority master data; `lead_vals_from_response()` helper
- [Modules/iap_mail](odoo-17/Modules/iap_mail.md) — `iap_mail.enrich_company` mail template for posting enrichment data
- [Modules/website_crm](odoo-18/Modules/website_crm.md) — Website contact form; used by the controller override
- [Modules/crm](odoo-18/Modules/CRM.md) — CRM base module
- [Core/API](odoo-18/Core/API.md) — `@api.model`, `@api.constrains`, `@tools.ormcache` usage in this module
