...
## See Also
- [Core/BaseModel](BaseModel.md) — Model definition, CRUD
- [Core/API](API.md) — @api.depends decorator
- [Tools/ORM Operations](ORM Operations.md) — search(), browse(), domain operators