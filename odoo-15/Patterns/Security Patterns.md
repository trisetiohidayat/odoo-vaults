...
- [Core/HTTP Controller](odoo-18/Core/HTTP Controller.md) — Auth types
- [Core/Exceptions](odoo-18/Core/Exceptions.md) — AccessError
- [Modules/res.partner](odoo-19/Modules/res.partner.md) — Partner security