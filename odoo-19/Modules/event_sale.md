...
- [Modules/event](event.md) — Base event module (`event.event`, `event.registration`, `event.event.ticket`)
- [Modules/event_product](event_product.md) — Product-event linking (`service_tracking = 'event'`, `product_id` on tickets)
- [Modules/sale](Sale.md) — Sale order flow (`sale.order`, `sale.order.line`)
- [Modules/website_event_sale](website_event_sale.md) — E-commerce integration (depends on `event_sale`)
- [Modules/website_event](website_event.md) — Event website pages and registration forms
