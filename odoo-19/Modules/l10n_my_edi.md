...
The module depends on [[Modules/l10n_my_ubl_pint]] for the underlying UBL format and reuses fields defined there.

## Dependencies

| Module | Purpose |
|--------|---------|
| [[Modules/l10n_my]] | Base Malaysian accounting localization |
| [[Modules/l10n_my_ubl_pint]] | UBL PINT format for e-invoice generation |
| [[Modules/account_edi_proxy_client]] | EDI proxy client for API communication |
...
- [[Modules/l10n_my]] - Core Malaysian accounting
- [[Modules/l10n_my_ubl_pint]] - UBL PINT format
- [[Modules/l10n_my_edi_pos]] - POS e-invoicing integration
