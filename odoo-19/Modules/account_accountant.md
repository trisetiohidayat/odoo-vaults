...
- [Modules/Account](odoo-18/Modules/account.md) — Core account.move, journal entries, reconcile models (base)
- [Modules/account_accountant](odoo-17/Modules/account_accountant.md) — This module (EE): bank rec widget, deferred, signing
- [Modules/Analytic](odoo-18/Modules/analytic.md) — analytic_distribution Json field used by widget lines
- [Modules/base_setup](odoo-17/Modules/base_setup.md) — Bank account configuration, statement import
