...
- [Modules/mrp_account](odoo-18/Modules/mrp_account.md) — MO costing, WIP journal entries, work order analytic lines, `manufacturing_order` AAL category
- [Modules/project_mrp](odoo-18/Modules/project_mrp.md) — `project_id` on MO (from BoM), project stat buttons for MOs and BoMs
- [Modules/Stock](odoo-18/Modules/stock.md) — Stock move costing and `_create_analytic_move()` from `stock_account`
