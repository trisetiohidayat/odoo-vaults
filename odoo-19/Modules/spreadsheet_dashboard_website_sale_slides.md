...
Provides a pre-configured [Modules/spreadsheet_dashboard](odoo-18/Modules/spreadsheet_dashboard.md) template for eLearning managers and course instructors to track enrollment, completion rates, and revenue from paid courses sold via the website.
...
- [Modules/website_slides](odoo-18/Modules/website_slides.md) — eLearning courses and slides
- [Modules/website_sale_slides](odoo-18/Modules/website_sale_slides.md) — Course sales via website
