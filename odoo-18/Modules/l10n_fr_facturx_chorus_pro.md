...
- account_edi_ubl_cii
- [l10n_fr_account](odoo-18/Modules/account.md)
...
## Chart of Accounts
Inherits from base `account` and [l10n_fr_account](odoo-18/Modules/account.md).

## Tax Structure
Inherits from [l10n_fr_account](odoo-18/Modules/account.md).
