...
| [[Modules/base_iban]] | Greek IBAN validation |
| [[Modules/base_vat]] | Greek AFM (Αριθμός Φορολογικού Μητρώου) validation |
...
- Validated via [[Modules/base_iban]]
...
| Module | Relationship |
|--------|-------------|
| [[Modules/l10n_gr_edi]] | myDATA e-invoicing and tax reporting |
...
5. Install [[Modules/l10n_gr_edi]] for myDATA compliance
...
- [[Modules/l10n_gr_edi]] provides mandatory myDATA tax reporting
- Community-maintained module (P. Christeas)

## See Also

- [[Modules/l10n_gr_edi]] - Greek myDATA e-invoicing
