...
- [[Modules/MRP]] — Manufacturing orders and workorders
- [[Modules/product_expiry]] — Product lot expiry tracking, `stock.lot` expiry fields, base wizard
- [[Modules/Stock]] — Lot numbers, `stock.move`, `stock.move.line`, FEFO reservation
- [[Modules/Stock]] — `stock.quant`, `stock.picking`, `stock.move` full field reference
