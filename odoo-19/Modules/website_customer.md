...
- [Modules/website_partner](odoo-18/Modules/website_partner.md) — Base partner website features (descriptions, is_published, SEO metadata)
- [Modules/website_crm_partner_assign](odoo-18/Modules/website_crm_partner_assign.md) — CRM partner grading and assignment (grades, weights, assigned_partner_id, implemented_partner_ids)
- [Modules/website_google_map](odoo-18/Modules/website_google_map.md) — Google Maps embedding on website pages
