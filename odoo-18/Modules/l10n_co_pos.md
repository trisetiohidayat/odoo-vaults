...
## Overview
Bridge module adding Colombian requirements to the Point of Sale application. Depends on [[Modules/l10n_co]] and `point_of_sale`. Loads Colombian-specific reference data into POS sessions.
