...
- [Modules/spreadsheet_dashboard](odoo-18/Modules/spreadsheet_dashboard.md) — Modern spreadsheet-based dashboards (parent menu root)
- [Modules/web](odoo-18/Modules/web.md) — Web client view registry, `/web/view/edit_custom` endpoint
