...
|------|------|-------------|
| 🔀 Technical Flow | [[Flows/HR/employee-creation-flow]] | Full method chain and branching |
| 📖 Module Reference | [[Modules/HR]] | Complete field and method reference |
| 📋 Related Guide | [[Business/HR/leave-management-guide]] | Leave management process |
...
| Type | Link | Description |
|------|------|-------------|
| 🔀 Technical Flow | [[Flows/HR/employee-creation-flow]] | Full method chain for developers |
| 📖 Module Reference | [[Modules/HR]] | Complete field and method reference |
| 📋 Leave Management | [[Business/HR/leave-management-guide]] | Managing employee leave |
