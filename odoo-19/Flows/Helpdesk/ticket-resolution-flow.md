...
- [Flows/Helpdesk/ticket-creation-flow](ticket-creation-flow.md) — Ticket creation and SLA application
- [Business/Helpdesk/helpdesk-configuration-guide](helpdesk-configuration-guide.md) — Configuring stages and rating
- [Patterns/Workflow Patterns](Workflow Patterns.md) — State machine pattern reference
- [Core/API](API.md) — @api.depends, write() override patterns
