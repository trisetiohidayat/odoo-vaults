...
This is an **Obsidian vault** containing structured documentation for the **Odoo 19** codebase. The notes are written in Obsidian Flavored Markdown with wikilinks (`[Modules/Stock](odoo-18/Modules/stock.md)`) and frontmatter tags. The actual Odoo 19 source code lives at `~/odoo/odoo19/` — the vault maps, explains, and cross-links that codebase.
