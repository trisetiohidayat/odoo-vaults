...
- [[Core/API]] -- ORM decorators like `@api.depends`, `@api.constrains`
- [[Core/BaseModel]] -- Model foundation, `_name`, `_inherit`, CRUD methods
- [[Patterns/Security Patterns]] -- ACL CSV, ir.rule, field groups
- [[Tools/ORM Operations]] -- `search()`, `browse()`, `create()`, `write()`, domain operators
- [[Modules/Stock]] -- Warehouse/Inventory (uses res.partner, res.company extensively)
- [[Modules/Purchase]] -- Purchase orders (uses res.partner)
- [[Modules/Account]] -- Accounting (uses res.partner, res.company, res.currency)
- [[Modules/Sale]] -- Sales (uses res.partner, commercial_partner_id)
