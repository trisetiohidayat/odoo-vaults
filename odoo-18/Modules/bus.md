...
## Related Links
- [Modules/mail](mail.md) — Main consumer of bus notifications
- [Core/HTTP Controller](HTTP Controller.md) — WebSocket endpoints
- [Modules/web](web.md) — Session info with websocket version
