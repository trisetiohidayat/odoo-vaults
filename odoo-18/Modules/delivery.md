...
- [Modules/Sale](sale.md) — Sale order being extended
- [Modules/Stock](stock.md) — Stock picking (extended by `stock_picking_delivery`)
- [New Features/New Modules](New Modules.md) — `delivery_dhl`, `delivery_fedex` carrier modules