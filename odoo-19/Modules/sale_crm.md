...
- [Modules/sale](Sale.md) — Core sale order module (`sale.order`, quotation lifecycle)
- [Modules/crm](CRM.md) — Core CRM module (`crm.lead`, lead/opportunity lifecycle, merge logic)
- [Modules/sales_team](sales_team.md) — CRM sales team module (contains `crm.team` base model)
