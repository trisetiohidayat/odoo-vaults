...
## Overview
Indonesian POS extension adding QRIS payment verification support to the Point of Sale module. Works in conjunction with [Modules/l10n_id](l10n_id.md) to enable QRIS-based payment and order tracking at POS terminals.
...
## Data Files
No separate data files — inherits all QRIS data structures from [Modules/l10n_id](l10n_id.md).
...
## Historical Notes
Version 1.0 in Odoo 18. Extends the QRIS payment mechanism from [Modules/l10n_id](l10n_id.md) into the POS workflow.