...
|------|------|-------------|
| 🔀 Technical Flow | [Flows/Website/website-sale-flow](website-sale-flow.md) | Full method chain and branching logic |
| 📖 Module Reference | [Modules/website_sale](website_sale.md) | Complete field and method reference |
| 📋 Related Guide | [Modules/website_sale](website_sale.md) | Website publishing checklist |
| 🔧 Configuration | [Modules/payment_stripe](payment_stripe.md) | Payment provider configuration |
...
| Type | Link | Description |
|------|------|-------------|
| 🔀 Technical Flow | [Flows/Website/website-sale-flow](website-sale-flow.md) | Full method chain — for developers |
| 📖 Module Reference | [Modules/website_sale](website_sale.md) | Complete field and method list |
| 📋 Related Guide | [Modules/website_sale](website_sale.md) | Website publishing and SEO |
...
| 💳 Payment | [Modules/payment_stripe](payment_stripe.md) | Detailed payment provider setup |
| 🚚 Delivery | [Business/Stock/warehouse-setup-guide](warehouse-setup-guide.md) | Advanced delivery configuration |
