...
Serbian SAF-T (JIS — Jedinstveni Informacioni Sistem) format. Turnover date field enables correct VAT period assignment in SAF-T exports. See also [l10n_rs_edi](l10n_rs_edi.md) for e-invoice (eFaktura) support.
