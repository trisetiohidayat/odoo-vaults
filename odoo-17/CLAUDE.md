...
### Wikilinks
Use Obsidian wikilinks: `[Core/BaseModel](Core/BaseModel.md)`, `[Modules/Stock](Modules/stock.md)`, `[Patterns/Security Patterns](odoo-18/Patterns/Security Patterns.md)`.
