...
related_guides:
  ...
  - "[Business/Sale/sales-process-guide](sales-process-guide.md)"
...
- [Modules/Sale](Sale.md) — Sale module reference (SO invoice creation)
- [Flows/Account/invoice-post-flow](invoice-post-flow.md) — Next step: posting the invoice
- [Flows/Account/payment-flow](payment-flow.md) — Payment registration after posting
