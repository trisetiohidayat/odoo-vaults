...
- [[Modules/sale_service]]
- [[Modules/sale_timesheet]] — Timesheet-linked billing, UDH conversion, SOL→AAL→invoice flow
- [[Modules/hr_timesheet]] — Timesheet entry model, portal rendering
- [[Core/API]]
