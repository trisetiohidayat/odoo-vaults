...
Bridge module between [[Modules/iap]] and [[Modules/CRM]]. Provides integration between IAP-based services (like lead enrichment and reveal) and the CRM pipeline.
...
- [[Modules/CRM]] — CRM pipeline and lead/opportunity management.
- [[Modules/iap_mail]] — IAP bus notifications and mail.thread on IAP accounts.
- [[Modules/crm_iap_enrich]] — IAP lead enrichment (company data enrichment).
- [[Modules/crm_iap_mine]] — IAP lead mining.
- [[Modules/partner_autocomplete]] — Company data autocomplete via IAP.
