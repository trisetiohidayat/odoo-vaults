...
- [[Modules/web]] — Web client architecture
- [[Modules/website_event_track]] — Event track module (uses web_tour for onboarding)
- [[Core/API]] — @api.depends, computed fields, stored computed patterns
- [[Patterns/Inheritance Patterns]] — Classical _inherit patterns used in web_tour
