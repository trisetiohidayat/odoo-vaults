...
## Overview
Bridge module for [[Modules/l10n_ar]] and `website_sale`. Exposes AFIP Responsibility Type and Identification Type fields in the eCommerce checkout form so Argentine customers can specify their fiscal condition during online purchases.
