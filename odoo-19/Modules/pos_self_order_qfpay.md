...
- [[Modules/pos_qfpay]] — QFPay terminal integration
- [[Modules/pos_self_order_razorpay]] — Razorpay terminal in self-order (polling, INR)
- [[Modules/pos_self_order_pine_labs]] — Pine Labs terminal in self-order (polling, paisa, INR)
