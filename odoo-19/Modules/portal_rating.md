...
Adds customer rating capabilities to the [Modules/portal](portal.md) (customer portal). Integrates ratings directly into the portal's discuss/chatter widget, allowing portal users to see and submit ratings from the customer-facing interface.
...
- [Modules/rating](rating.md) — Core rating framework (rating mixin, parent rating).
- [Modules/portal](portal.md) — Portal customer access and chatter.
- [Modules/mail](mail.md) — Message/thread system.
