...
## Overview
Bridge module adding Peruvian requirements to the Point of Sale application. Depends on [[Modules/l10n_pe]] and `point_of_sale`. Extends POS sessions to load Peruvian reference data (districts, identification types) and sets default values for the POS customer.
