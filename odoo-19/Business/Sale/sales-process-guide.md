...
related_guides:
  - "[Business/Stock/warehouse-setup-guide](odoo-19/Business/Stock/warehouse-setup-guide.md)"
...
|------|------|-------------|
| 🔀 Technical Flow | [Flows/Sale/quotation-to-sale-order-flow](odoo-19/Flows/Sale/quotation-to-sale-order-flow.md) | Full method chain and branching logic for order creation |
| 📖 Module Reference | [Modules/Sale](odoo-18/Modules/sale.md) | Complete field and method reference for sale.order |
| 📋 Related Guide | [Business/Account/chart-of-accounts-guide](odoo-19/Business/Account/chart-of-accounts-guide.md) | Invoice and payment management |
| 📋 Related Guide | [Business/Stock/warehouse-setup-guide](odoo-19/Business/Stock/warehouse-setup-guide.md) | Delivery and warehouse operations |
| 🔧 Configuration | [Modules/Sale](odoo-18/Modules/sale.md) → Configuration section | Advanced sales team and workflow settings |
...
> **⚡ System Trigger:** `account.move.action_post()` — see [Flows/Account/invoice-post-flow](odoo-19/Flows/Account/invoice-post-flow.md) for full chain.
...
> **⚡ System Trigger:** `account.payment.action_post()` — see [Flows/Account/payment-flow](odoo-19/Flows/Account/payment-flow.md) for full chain.
...
| Type | Link | Description |
|------|------|-------------|
| 🔀 Technical Flow | [Flows/Sale/quotation-to-sale-order-flow](odoo-19/Flows/Sale/quotation-to-sale-order-flow.md) | Full method chain — for developers |
| 📖 Module Reference | [Modules/Sale](odoo-18/Modules/sale.md) | Complete field and method list |
| 🔀 Technical Flow | [Flows/Account/invoice-creation-flow](odoo-19/Flows/Account/invoice-creation-flow.md) | Invoice creation from SO |
...
| 📋 Related Guide | [Business/Stock/warehouse-setup-guide](odoo-19/Business/Stock/warehouse-setup-guide.md) | Delivery and warehouse operations |
| 📋 Related Guide | [Business/Account/chart-of-accounts-guide](odoo-19/Business/Account/chart-of-accounts-guide.md) | Accounting and invoicing |
