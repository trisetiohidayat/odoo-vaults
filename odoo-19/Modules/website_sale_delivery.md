...
- [[Modules/delivery]] — Base carrier model, rate computation, pickup locations
- [[Modules/website_sale]] — eCommerce base: cart, checkout, payment
- [[Modules/website_sale_mondialrelay]] — Point Relais integration via `delivery_mondialrelay`
- [[Modules/stock]] — Inventory; shipping_weight used by `base_on_rule` rate computation
- [[Modules/sale]] — `carrier_id`, `delivery_set`, `shipping_weight` fields
