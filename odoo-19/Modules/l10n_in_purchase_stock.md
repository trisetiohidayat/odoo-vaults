...
## Related
- [Modules/l10n_in_stock](l10n_in_stock.md) — Indian warehouse accounting
- [Modules/l10n_in_purchase_stock](l10n_in_purchase_stock.md) — Indian purchase order accounting
- [Modules/l10n_in](l10n_in.md) — Core Indian accounting
- [Modules/purchase_stock](purchase_stock.md) — Base purchase-stock bridge
