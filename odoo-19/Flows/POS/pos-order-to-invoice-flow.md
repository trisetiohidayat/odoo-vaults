...
related_guides:
  - "[Business/POS/pos-configuration-guide](pos-configuration-guide.md)"
  - "[Flows/Account/invoice-creation-flow](invoice-creation-flow.md)"
source_module: pos
...
- [Flows/POS/pos-session-flow](pos-session-flow.md) — Session lifecycle and payment registration
- [Flows/Account/invoice-creation-flow](invoice-creation-flow.md) — Generic invoice creation flow
- [Flows/Account/payment-flow](payment-flow.md) — Payment matching and reconciliation
- [Business/POS/pos-configuration-guide](pos-configuration-guide.md) — POS setup including invoice journal
- [Flows/Account/invoice-creation-flow](invoice-creation-flow.md) — Manual invoicing guide
- [Modules/pos](pos.md) — Full POS module reference
- [Modules/Account](Account.md) — account.move, journal entries
- [Modules/res.partner](res.partner.md) — Partner model
