...
- [[Modules/Mass Mailing]] — `mass_mailing` base
- [[Modules/Website]] — `website` base
- [[Modules/Link Tracker]] — `link_tracker` for short URLs
- [[New Features/What's New]] — Odoo 18 marketing_card changes
