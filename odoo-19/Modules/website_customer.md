...
- [[Modules/website_partner]] — Base partner website features (descriptions, is_published, SEO metadata)
- [[Modules/website_crm_partner_assign]] — CRM partner grading and assignment (grades, weights, assigned_partner_id, implemented_partner_ids)
- [[Modules/website_google_map]] — Google Maps embedding on website pages
