...
- [Modules/HR](HR.md) — HR module reference (includes hr_contract section)
- [Modules/resource](resource.md) — resource.resource, resource.calendar
- [Flows/HR/employee-creation-flow](employee-creation-flow.md) — Employee creation
- [Flows/HR/employee-archival-flow](employee-archival-flow.md) — Archival on termination
