...
Extends `stock.picking.type` with batch-specific fields (see [[Modules/stock_picking_type]]).
...
- [[Modules/stock]] — `stock.picking`, `stock.move`
- [[Modules/stock_picking_type]] — picking type batch configuration
- [[Modules/stock_warehouse]] — warehouse picking types
