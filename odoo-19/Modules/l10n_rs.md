...
| [Modules/base_vat](base_vat.md) | Serbian PIB (Matični broj) validation |
...
- Format validated via [Modules/base_vat](base_vat.md)
...
| Module | Relationship |
|--------|-------------|
| [Modules/l10n_rs_edi](l10n_rs_edi.md) | Serbian eFaktura EDI integration |
...
4. Install [Modules/l10n_rs_edi](l10n_rs_edi.md) for eFaktura compliance
...
- [Modules/l10n_rs_edi](l10n_rs_edi.md) - Serbian eFaktura
