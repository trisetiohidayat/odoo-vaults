...
Provides a pre-configured [[Modules/spreadsheet_dashboard]] template combining sales order data with timesheet billing metrics. Shows revenue recognized from time-and-materials sales alongside project time tracking.
...
- [[Modules/sale_timesheet]] — Timesheet-based billing on sales orders
- [[Modules/hr_timesheet]] — Timesheet entry
