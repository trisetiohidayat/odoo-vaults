...
### Related Modules
- [[Modules/Calendar]] — Base calendar module (dependency)
- [[Core/API]] — @api decorators used in sync logic
- [[Core/Fields]] — Relational fields (Many2one, One2many) used for attendees
