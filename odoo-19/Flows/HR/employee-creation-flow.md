...
- [Modules/HR](HR.md) — Module reference (includes method chain summary)
- [Business/HR/quickstart-employee-setup](quickstart-employee-setup.md) — Step-by-step guide
- [Flows/HR/employee-archival-flow](employee-archival-flow.md) — Archive/unarchive flow
- [Modules/resource](resource.md) — resource.resource model
