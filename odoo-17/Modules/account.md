...
- [Modules/Payment](payment.md) — `account.payment` model, payment workflows
...
- [Tools/ORM Operations](ORM Operations.md) — `search()`, `browse()`, `write()` fundamentals
- [Patterns/Security Patterns](Security Patterns.md) — ACL CSV, `ir.rule` for account records
