...
- [Modules/mail](odoo-18/Modules/mail.md) — Mail threading and messaging
- [Modules/sale](odoo-18/Modules/sale.md) — Sale orders portal access
- [Modules/account](odoo-18/Modules/account.md) — Invoice portal access
