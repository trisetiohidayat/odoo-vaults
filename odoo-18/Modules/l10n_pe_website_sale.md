...
## Overview
Bridge module connecting [[Modules/l10n_pe]] with `website_sale`. Exposes the Peruvian Identification Type (DNI, RUC, Carnet de Extranjeria) in the eCommerce checkout form so online customers can select their document type during purchase. Auto-installs with website_sale and l10n_pe.
