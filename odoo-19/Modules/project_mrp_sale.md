...
- [Modules/project_mrp](odoo-18/Modules/project_mrp.md) — MRP ↔ Project bridge (this module's foundation)
- [Modules/sale_mrp](odoo-18/Modules/sale_mrp.md) — Sale ↔ MRP bridge
- [Modules/sale_project](odoo-18/Modules/sale_project.md) — Sale ↔ Project bridge
- [Modules/mrp](odoo-18/Modules/mrp.md) — MRP (Manufacturing) module reference
- [Modules/project](odoo-18/Modules/project.md) — Project management module reference
- [Modules/project_mrp_account](odoo-18/Modules/project_mrp_account.md) — MRP + Account bridge (adds profitability)
- [Modules/project_mrp_stock_landed_costs](odoo-18/Modules/project_mrp_stock_landed_costs.md) — MRP + Account + Landed Costs
