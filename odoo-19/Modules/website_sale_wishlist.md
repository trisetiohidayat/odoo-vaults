...
- **[[Modules/website_sale]]**: Full dependency. `website_sale` provides the product catalog (`shop_product_buttons`, `products_item`, `cart_lines`), pricelist infrastructure, and checkout flow. Wishlist is purely an enhancement layer.
