...
- [Modules/website](odoo-18/Modules/website.md) — base website module
- [Modules/web_studio](odoo-19/Modules/web_studio.md) — the application-level studio engine (enterprise)
