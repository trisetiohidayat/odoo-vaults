...
- [[Modules/sale_purchase]] — Core SO to PO linking
- [[Modules/project_purchase]] — PO costs in project profitability
- [[Modules/sale_project]] — Task generation from SOs
- [[Patterns/Workflow Patterns]] — State machine patterns
- [[Modules/Stock]] — Stock move costing (`_create_analytic_move`)
