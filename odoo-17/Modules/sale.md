...
- [Modules/sale_stock](sale_stock.md) — Picking creation on SO confirmation
- [Modules/account](account.md) — Invoice creation and payment
- [Modules/sale_management](sale_management.md) — `done` state locking, discount wizard
- [Modules/sale_loyalty](sale_loyalty.md) — Loyalty programs applied to SOs
- [Modules/sale_mrp](sale_mrp.md) — Kit products and kit delivery logic
- [Modules/hr_expense](hr_expense.md) — Expense products create analytic entries on confirmed SOs