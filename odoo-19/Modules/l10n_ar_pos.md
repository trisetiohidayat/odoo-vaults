...
## Related
- [Modules/l10n_ar](l10n_ar.md) — Core Argentinean accounting
- [Modules/l10n_ar_website_sale](l10n_ar_website_sale.md) — Argentine eCommerce
- [Modules/l10n_ar_withholding](l10n_ar_withholding.md) — Argentine withholding tax
- [Modules/l10n_ar_stock](l10n_ar_stock.md) — Argentine inventory/warehouse
