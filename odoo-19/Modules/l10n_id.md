...
### Related Flows
- [Flows/Cross-Module/purchase-stock-account-flow](odoo-19/Flows/Cross-Module/purchase-stock-account-flow.md) — PO→Receipt→Vendor Bill (with PPN tax)
- [Flows/Account/payment-flow](odoo-19/Flows/Account/payment-flow.md) — QRIS payment collection
...
- [Modules/account](odoo-18/Modules/account.md) — Core accounting: journals, taxes, move posting
- [Modules/l10n_id_efaktur_coretax](odoo-18/Modules/l10n_id_efaktur_coretax.md) — e-Faktur / CoreTax EDI export (separate module)
- [Modules/l10n_id_pos](odoo-18/Modules/l10n_id_pos.md) — Indonesian POS localization
