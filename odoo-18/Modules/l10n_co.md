...
## Overview
Colombian accounting localization providing the chart of accounts, taxes, and DIAN (Direccion de Impuestos y Aduanas Nacionales) document types. Authored by David Arnold (XOE Solutions). Requires [Modules/l10n_latam_base](l10n_latam_base.md) and `account_debit_note`.
