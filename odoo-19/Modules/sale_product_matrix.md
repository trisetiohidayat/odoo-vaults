...
- [Modules/sale](Sale.md) — Base Sale module (sale.order, sale.order.line)
- [Modules/product_matrix](product_matrix.md) — Technical matrix module (grid computation, OWL dialog, QWeb templates)
- [Modules/sale_product_configurator](sale_product_configurator.md) — Standard product configurator frontend
- [Modules/purchase_product_matrix](purchase_product_matrix.md) — Analogous purchase order matrix (no `product_add_mode` gating)
