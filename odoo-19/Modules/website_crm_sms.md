...
- [[Modules/website_sms]] — Base SMS on website visitors, provides `action_send_sms()` and SMS composer integration
- [[Modules/website_crm]] — Website CRM lead capture, provides `lead_ids` on `website.visitor` and visitor/lead synchronization
- [[Modules/CRM]] — CRM lead/opportunity management, provides `_sort_by_confidence_level()` and `crm.lead` model
- [[Modules/sms]] — Core SMS sending module, provides `sms.composer` wizard
- [[Modules/website_crm_livechat]] — Links livechat sessions to CRM leads
