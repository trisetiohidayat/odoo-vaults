...
## Country
[[Modules/Account|Belgium]] 🇧🇪

## Dependencies
- pos_sale
- [[Modules/Account|l10n_be]]
...
## Chart of Accounts
Inherits from [[Modules/Account|l10n_be]].

## Tax Structure
Inherits from [[Modules/Account|l10n_be]].

## Fiscal Positions
Intra-community fiscal position (`fiscal_position_template_3`) from [[Modules/Account|l10n_be]]: maps domestic Belgian VAT to 0% intra-community (reverse charge).
