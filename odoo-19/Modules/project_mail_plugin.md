...
- [Modules/mail_plugin](odoo-17/Modules/mail_plugin.md) — Mail plugin base (Outlook/Gmail integration)
- [Modules/project_todo](odoo-18/Modules/project_todo.md) — To-do tasks
