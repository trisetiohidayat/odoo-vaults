...
- [Modules/spreadsheet_dashboard](spreadsheet_dashboard.md) — Modern spreadsheet-based dashboards (parent menu root)
- [Modules/web](web.md) — Web client view registry, `/web/view/edit_custom` endpoint
- [Core/HTTP Controller](HTTP Controller.md) — Odoo HTTP route decorators, `auth='user'`
- [Tools/ORM Operations](ORM Operations.md) — `ir.ui.view.custom` model, view customization system
