...
- [[Modules/Calendar]] — base calendar module (alarm model, event model, alarm manager cron)
- [[Modules/SMS]] — SMS provider integration and `sms.template`
- [[Core/API]] — mixin patterns, `_mail_get_partners()`
