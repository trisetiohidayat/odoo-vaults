...
- [[Modules/Payment]] — `account.payment` model, payment workflows
- [[Modules/AccountAnticipation]] — early payment discounts, EPD
- [[Modules/AccountFollowup]] — partner payment follow-up / dunning
- [[Modules/AccountBatchPayment]] — batch payment processing
- [[Modules/AccountDebitNote]] — debit note issuance
- [[Modules/AccountTaxCalculation]] — tax calculation details
- [[Tools/ORM Operations]] — `search()`, `browse()`, `write()` fundamentals
- [[Patterns/Security Patterns]] — ACL CSV, `ir.rule` for account records
