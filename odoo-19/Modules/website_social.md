...
The `mass_mailing` module provides social media icon blocks (`s_header_social`, `s_footer_social`) for email templates — see [Modules/mass_mailing_themes](odoo-17/Modules/mass_mailing_themes.md) for the themed versions.
...
- [Modules/website](odoo-18/Modules/website.md) — Core website builder
- [Modules/social_media](odoo-18/Modules/social_media.md) — Social media account configuration
- [Modules/mass_mailing](odoo-18/Modules/mass_mailing.md) — Email campaign social snippets
- [Modules/mass_mailing_themes](odoo-17/Modules/mass_mailing_themes.md) — Themed email templates with social media headers
