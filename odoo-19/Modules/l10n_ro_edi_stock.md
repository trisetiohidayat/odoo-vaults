...
| Module | Purpose |
|--------|---------|
| [Modules/stock_delivery](stock_delivery.md) | Stock delivery integration |
| [Modules/l10n_ro_edi](l10n_ro_edi.md) | ANAF e-Factura base (provides API utilities) |
| [Modules/stock_picking_batch](stock_picking_batch.md) | Batch picking support (also required) |
...
| [Modules/l10n_ro_edi](l10n_ro_edi.md) | ANAF e-Factura (provides shared API utilities) |
| [Modules/l10n_ro_edi_stock_batch](l10n_ro_edi_stock_batch.md) | e-Transport for batch pickings |
| [Modules/Stock](Stock.md) | Stock management |
| [Modules/stock_delivery](stock_delivery.md) | Delivery integration |
...
- Uses the same ANAF access token as [Modules/l10n_ro_edi](l10n_ro_edi.md) e-Factura
