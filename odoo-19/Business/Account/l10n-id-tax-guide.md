...
related_flows:
  ...
  - "[Flows/Purchase/purchase-withholding-flow](purchase-withholding-flow.md)"
...
|------|------|-------------|
| 🔀 Technical Flow | [Flows/Purchase/purchase-withholding-flow](purchase-withholding-flow.md) | Full withholding tax method chain |
| 🔀 Technical Flow | [Flows/Account/edi-invoice-flow](edi-invoice-flow.md) | Peppol/e-Faktur integration |
| 📖 Module Reference | [Modules/Account](Account.md) | `account.move`, `account.tax` fields |
| 📋 Related Guide | [Business/Account/chart-of-accounts-guide](chart-of-accounts-guide.md) | Indonesian COA structure |
| 🔧 Configuration | [Modules/Account](Account.md) → Tax Configuration | Tax groups, rates, fiscal positions |
...
| Type | Link | Description |
|------|------|-------------|
| 🔀 Technical Flow | [Flows/Purchase/purchase-withholding-flow](purchase-withholding-flow.md) | Full PPh 21/22/23/26 method chain |
| 🔀 Technical Flow | [Flows/Account/edi-invoice-flow](edi-invoice-flow.md) | e-Faktur + Peppol integration |
| 🔀 Technical Flow | [Flows/Stock/stock-valuation-flow](stock-valuation-flow.md) | Landed costs with PPN treatment |
| 📖 Module Reference | [Modules/Account](Account.md) | `account.move`, `account.tax` fields |
| 📋 Related Guide | [Business/Account/chart-of-accounts-guide](chart-of-accounts-guide.md) | Indonesian COA setup |
| 🔧 Patterns | [Patterns/Security Patterns](Security Patterns.md) | Tax computation and fiscal positions |
| 🛠️ Snippets | [Snippets/Model Snippets](Model Snippets.md) | Code for custom tax computation |
