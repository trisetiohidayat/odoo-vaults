...
- [Modules/im_livechat](odoo-17/Modules/im_livechat.md) — Core livechat framework; `chatbot.script`, `discuss.channel`
- [Modules/website_hr_recruitment](odoo-18/Modules/website_hr_recruitment.md) — Website job board; provides `/jobs` page and `hr.applicant` model
- [Modules/hr_recruitment](odoo-17/Modules/hr_recruitment.md) — Backend recruitment; `hr.applicant`, `hr.job`, `hr.department`
