...
- [Core/API](API.md) — @api.model, @api.depends decorators, name_create context
- [Tools/ORM Operations](ORM Operations.md) — search(), browse(), load() methods
- [Patterns/Inheritance Patterns](Inheritance Patterns.md) — Extending base_import for custom formats
- [New Features/What's New](What's New.md) — Odoo 19 OWL import UI changes
