...
- [Core/API](API.md) — `@api.model` decorator context
- [Core/Fields](Fields.md) — `config_parameter` field type
- [Patterns/Security Patterns](Security Patterns.md) — ACL and access control in Odoo
