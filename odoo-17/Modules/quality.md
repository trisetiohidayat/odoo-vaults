...
- [Modules/stock](odoo-18/Modules/stock.md) — picking types, stock moves (includes quality fields in community)
- [Modules/mrp](odoo-18/Modules/mrp.md) — production quality integration
