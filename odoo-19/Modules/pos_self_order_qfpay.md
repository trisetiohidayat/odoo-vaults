...
- [Modules/pos_qfpay](pos_qfpay.md) — QFPay terminal integration
- [Modules/pos_self_order_razorpay](pos_self_order_razorpay.md) — Razorpay terminal in self-order (polling, INR)
- [Modules/pos_self_order_pine_labs](pos_self_order_pine_labs.md) — Pine Labs terminal in self-order (polling, paisa, INR)
