...
- [ ] Related: [Modules/Account](Account.md), [Modules/Purchase](Purchase.md), [Modules/Sale](Sale.md)
...
- [ ] Link to [Modules/Account](Account.md) for generic flows
...
**Final deliverable:** [Documentation/Upgrade-Plan/CHECKPOINT-master](CHECKPOINT-master.md)
