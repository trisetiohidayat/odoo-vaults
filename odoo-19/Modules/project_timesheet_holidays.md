...
- [[Modules/hr_holidays]] — Leave management (approval, refusal, cancellation)
- [[Modules/hr_timesheet]] — Timesheet entry (analytic lines, internal project creation)
- [[Modules/project]] — Project and task models
- [[Modules/Account]] — Analytic account for project accounting
- [[Core/Fields]] — Many2one, One2many, computed fields
---
