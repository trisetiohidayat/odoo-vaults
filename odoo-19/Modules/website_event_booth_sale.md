...
- [Modules/website_event_booth](website_event_booth.md) — public booth registration portal (free booths, no payment)
- [Modules/Sale](Sale.md) — sale order and cart mechanics
- [Modules/website_sale](website_sale.md) — website e-commerce integration
- [Modules/Event](event.md) — event management base module
