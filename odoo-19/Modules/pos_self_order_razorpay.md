...
- [[Modules/pos_self_order]] — Base self-order module (provides `PosSelfOrderController`, `_send_payment_result`, `_verify_pos_config`)
- [[Modules/pos_razorpay]] — Razorpay terminal integration (provides `RazorpayPosRequest`, API methods)
- [[Modules/pos_self_order_adyen]] — Adyen terminal in self-order (push-based webhook pattern)
- [[Modules/pos_self_order_pine_labs]] — Pine Labs terminal in self-order (polls paisa-based amounts)
- [[Modules/pos_self_order_qfpay]] — QFPay terminal in self-order (webhook with HKD currency)
