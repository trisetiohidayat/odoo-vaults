...
- [[Modules/iap_crm]] — IAP account integration and credit management
- [[Modules/crm_iap_mine]] — Industry/role/seniority master data; `lead_vals_from_response()` helper
- [[Modules/iap_mail]] — `iap_mail.enrich_company` mail template for posting enrichment data
- [[Modules/website_crm]] — Website contact form; used by the controller override
- [[Modules/crm]] — CRM base module
- [[Core/API]] — `@api.model`, `@api.constrains`, `@tools.ormcache` usage in this module
- [[Patterns/Workflow Patterns]] — Cron-based batch pipeline pattern
