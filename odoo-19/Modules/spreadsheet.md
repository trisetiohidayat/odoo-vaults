...
- [Modules/spreadsheet_dashboard](spreadsheet_dashboard.md) — Dashboard templates using `spreadsheet.mixin`
- [Modules/spreadsheet_account](spreadsheet_account.md) — Accounting data source and currency formulas
- [Core/API](API.md) — `@api.model` RPC methods, `@api.constrains`, `@api.depends`
- [Core/Fields](Fields.md) — Binary field storage, computed/inverse pattern
- [Patterns/Workflow Patterns](Workflow Patterns.md) — Collaboration patterns via `bus` module
- [Modules/bus](bus.md) — WebSocket real-time collaboration
