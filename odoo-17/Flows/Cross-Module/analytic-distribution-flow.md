...
## See Also
- [Modules/analytic](analytic.md) — `account.analytic.account`, `account.analytic.plan`
- [Modules/account](account.md) — `account.move.line`, `analytic_distribution` field
- [Flows/Cross-Module/accounting-reconciliation-flow](accounting-reconciliation-flow.md) — reconciliation that may trigger CABA
- [Flows/Sale/full-sale-to-cash-flow](full-sale-to-cash-flow.md) — sale with analytics end-to-end
- [Flows/Purchase/full-purchase-to-payment-flow](full-purchase-to-payment-flow.md) — purchase with analytics end-to-end
