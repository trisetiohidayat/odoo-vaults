...
- `[Modules/Stock](odoo-18/Modules/stock.md)` — stock.move, stock.picking, stock.quant structure
- `[Core/API](odoo-18/Core/API.md)` — @api.depends, @api.constrains decorators
- `[Patterns/Workflow Patterns](odoo-18/Patterns/Workflow Patterns.md)` — state machine design pattern
