...
|------|------|-------------|
| 🔀 Technical Flow | [[Flows/Stock/receipt-flow]] | Receipt process |
| 🔀 Technical Flow | [[Flows/Stock/delivery-flow]] | Delivery process |
| 📖 Module Reference | [[Modules/Stock]] | Complete model reference |
...
| Type | Link | Description |
|------|------|-------------|
| 🔀 Receipt Flow | [[Flows/Stock/receipt-flow]] | Incoming receipt process |
| 🔀 Delivery Flow | [[Flows/Stock/delivery-flow]] | Outgoing delivery process |
| 🔀 Picking Actions | [[Flows/Stock/picking-action-flow]] | confirm→assign→done |
| 📖 Module Reference | [[Modules/Stock]] | Complete model reference |
