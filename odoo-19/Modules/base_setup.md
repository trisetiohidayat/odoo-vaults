...
- [Core/BaseModel](BaseModel.md) — TransientModel lifecycle and auto-cleanup behavior
- [Core/Fields](Fields.md) — `config_parameter` attribute, `related` field pattern
- [Patterns/Security Patterns](Security Patterns.md) — group implication, access rights defaults
- [Modules/base](base.md) — parent `res.config.settings` model from which base_setup inherits
