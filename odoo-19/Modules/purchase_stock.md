...
- [[Modules/Stock]] — Core stock module (`stock.picking`, `stock.move`, `stock.quant`)
- [[Modules/Purchase]] — Purchase order module (`purchase.order`, `purchase.order.line`)
- [[Modules/stock_account]] — Inventory valuation accounting entries
- [[Modules/sale_stock]] — Sale order to delivery integration, including dropship
- [[Modules/stock_dropshipping]] — Standalone dropshipping without sale order
- [[Patterns/Workflow Patterns]] — State machine and action methods (relevant for `state` field lifecycle)
