...
- [Modules/website](website.md) -- Website framework (required dependency)
- [Modules/website_mail](website_mail.md) -- Comment/discussion integration
- [Modules/website_partner](website_partner.md) -- Author partner profiles
- [Modules/website_slides](website_slides.md) -- E-learning (uses similar content patterns)
- [Modules/website_event](website_event.md) -- Event module (similar architecture)
- [Core/API](API.md) -- @api.depends, computed fields, inverse methods
- [Patterns/Workflow Patterns](Workflow Patterns.md) -- State machine and action methods
- [Modules/res.partner](res.partner.md) -- Author partner model
- [Core/Fields](Fields.md) -- Field type reference (Char, Many2one, Html, etc.)
