...
- [[Modules/account-peppol]] — Peppol e-invoicing via Odoo's Access Point
- [[Modules/Account]] — Core accounting, `account.move` lifecycle
- [[Core/Fields]] — How Many2one, One2many, Binary fields work
