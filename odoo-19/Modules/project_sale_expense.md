...
| Module | Description |
|--------|-------------|
| [Modules/hr_expense](odoo-18/Modules/hr_expense.md) | Base expense management (sheets removed in Odoo 19) |
| [Modules/sale_expense](odoo-18/Modules/sale_expense.md) | Links expenses to sale orders; creates SOLs on vendor bill posting |
| [Modules/project_hr_expense](odoo-18/Modules/project_hr_expense.md) | Shows expense costs on project profitability |
| [Modules/sale_project](odoo-18/Modules/sale_project.md) | Links sale orders to projects |
| [Modules/Project](odoo-18/Modules/project.md) | Base project model with profitability framework |
