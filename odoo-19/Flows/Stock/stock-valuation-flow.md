...
related_flows:
  ...
  - "[Modules/stock_landed_costs](odoo-18/Modules/stock_landed_costs.md)"
...
- [Modules/Stock](odoo-18/Modules/stock.md) — `stock.move`, `stock.quant`, `stock.valuation.layer` field reference
- [Flows/Stock/receipt-flow](odoo-17/Flows/Stock/receipt-flow.md) — Purchase receipt from PO to quant
- [Flows/Stock/delivery-flow](odoo-19/Flows/Stock/delivery-flow.md) — Sales delivery from SO to quant
- [Modules/stock_landed_costs](odoo-18/Modules/stock_landed_costs.md) — Landed cost integration with valuation
- [Patterns/Workflow Patterns](odoo-18/Patterns/Workflow Patterns.md) — State machine pattern in Odoo
- [Core/API](odoo-18/Core/API.md) — `@api.depends` decorator for computed fields
