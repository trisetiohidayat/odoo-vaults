...
Extends `stock.picking.type` with batch-specific fields (see [Modules/stock_picking_type](odoo-17/Modules/stock_picking_type.md)).
...
- [Modules/stock](odoo-18/Modules/stock.md) — `stock.picking`, `stock.move`
- [Modules/stock_picking_type](odoo-17/Modules/stock_picking_type.md) — picking type batch configuration
- [Modules/stock_warehouse](odoo-17/Modules/stock_warehouse.md) — warehouse picking types
