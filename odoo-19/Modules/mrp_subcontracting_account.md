...
| Module | Relationship |
|---|---|
| `[Modules/mrp_subcontracting](mrp_subcontracting.md)` | Core dependency — provides the subcontracting workflow |
| `[Modules/mrp_account](mrp_account.md)` | Core dependency — provides `extra_cost` field and base `_cal_price` |
