...
related_flows:
  - "[Flows/POS/pos-session-flow](pos-session-flow.md)"
  - "[Flows/POS/pos-order-to-invoice-flow](pos-order-to-invoice-flow.md)"
...
|------|------|-------------|
| Technical Flow | [Flows/POS/pos-session-flow](pos-session-flow.md) | Full session lifecycle method chain |
| Technical Flow | [Flows/POS/pos-order-to-invoice-flow](pos-order-to-invoice-flow.md) | Order-to-invoice method chain |
| Module Reference | [Modules/pos](pos.md) | Complete POS model and field reference |
| Configuration | [Modules/pos](pos.md) → Payment Methods | Payment method setup details |
| Related Guide | [Business/Account/chart-of-accounts-guide](chart-of-accounts-guide.md) | Accounting journals and accounts |
...
| Type | Link | Description |
|------|------|-------------|
| Technical Flow | [Flows/POS/pos-session-flow](pos-session-flow.md) | Full session lifecycle — for developers |
| Technical Flow | [Flows/POS/pos-order-to-invoice-flow](pos-order-to-invoice-flow.md) | Order-to-invoice method chain |
| Module Reference | [Modules/pos](pos.md) | Complete POS model, field, and method reference |
| Module Reference | [Modules/Account](Account.md) | account.move, journal configuration |
| Module Reference | [Modules/res.partner](res.partner.md) | Partner model for customer management |
| Patterns | [Patterns/Workflow Patterns](Workflow Patterns.md) | State machine design for sessions |
| Security | [Patterns/Security Patterns](Security Patterns.md) | ACL for POS users and cashiers |
| Accounting Guide | [Business/Account/chart-of-accounts-guide](chart-of-accounts-guide.md) | Journal and account setup |
| Snippets | [Snippets/Model Snippets](Model Snippets.md) | Code templates for POS customization |
