...
- [Modules/account_peppol](account_peppol.md) — Primary consumer; PEPPOL network integration
- [Modules/l10n_it_edi](l10n_it_edi.md) — Italian SDI integration (extends same proxy)
- [Modules/certificate](certificate.md) — RSA key generation and storage
- [Modules/purchase_edi_ubl_bis3](purchase_edi_ubl_bis3.md) — Purchase order UBL export (uses proxy indirectly via account_peppol)
- [Modules/account_edi_ubl_cii](account_edi_ubl_cii.md) — UBL BIS 3 invoice/credit note export
