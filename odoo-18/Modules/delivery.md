...
- [[Modules/Sale]] — Sale order being extended
- [[Modules/Stock]] — Stock picking (extended by `stock_picking_delivery`)
- [[New Features/New Modules]] — `delivery_dhl`, `delivery_fedex` carrier modules