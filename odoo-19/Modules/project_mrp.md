...
- [Modules/project_mrp_account](odoo-18/Modules/project_mrp_account.md) — MRP + Account bridge
- [Modules/project_mrp_sale](odoo-18/Modules/project_mrp_sale.md) — MRP + Sale bridge (triple integration)
