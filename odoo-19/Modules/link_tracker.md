...
- [Modules/mail](odoo-18/Modules/mail.md) -- Inherits `mail.render.mixin`; all outgoing emails have links automatically shortened
- `mass_mailing` -- Extensive use of `search_or_create()` for per-link tracking in email campaigns
- [Modules/utm](odoo-18/Modules/utm.md) -- Provides UTM mixin and campaign/source/medium models
