...
## Overview
Bridge module connecting [Modules/l10n_uy](odoo-18/Modules/l10n_uy.md) with `website_sale`. Adds Uruguayan localization fields (department, locality) to the website address form and supports the Uruguayan consumer final partner in the eCommerce checkout.
