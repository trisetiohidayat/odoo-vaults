...
- [[Flows/Stock/delivery-flow]] — Outgoing delivery (applies this action flow)
- [[Flows/Stock/receipt-flow]] — Incoming receipt (applies this action flow)
- [[Flows/Stock/internal-transfer-flow]] — Internal transfer (applies this action flow)
