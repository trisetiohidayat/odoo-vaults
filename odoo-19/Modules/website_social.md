...
The `mass_mailing` module provides social media icon blocks (`s_header_social`, `s_footer_social`) for email templates — see [[Modules/mass_mailing_themes]] for the themed versions.
...
- [[Modules/website]] — Core website builder
- [[Modules/social_media]] — Social media account configuration
- [[Modules/mass_mailing]] — Email campaign social snippets
- [[Modules/mass_mailing_themes]] — Themed email templates with social media headers
