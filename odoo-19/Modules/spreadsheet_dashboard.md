...
- [Modules/spreadsheet_account](spreadsheet_account.md) — Accounting formulas used inside dashboard spreadsheets
- [Modules/spreadsheet](spreadsheet.md) — Core spreadsheet engine
- [Core/API](API.md) — Computed fields, @api.depends_context
- [Patterns/Security Patterns](Security Patterns.md) — Token-based access control
