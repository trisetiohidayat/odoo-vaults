...
- [Modules/pos_self_order](pos_self_order.md) — Base self-order module
- [Modules/pos_adyen](pos_adyen.md) — Adyen terminal integration
- [Modules/pos_self_order_razorpay](pos_self_order_razorpay.md) — Razorpay terminal in self-order (polling-based, INR)
- [Modules/pos_self_order_pine_labs](pos_self_order_pine_labs.md) — Pine Labs terminal in self-order (polling with paisa conversion, INR)
- [Modules/pos_self_order_qfpay](pos_self_order_qfpay.md) — QFPay terminal in self-order (webhook with HKD)
