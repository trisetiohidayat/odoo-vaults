...
| Module | Relationship |
|---|---|
| `[[Modules/mrp_subcontracting]]` | Core dependency — provides the subcontracting workflow |
| `[[Modules/mrp_account]]` | Core dependency — provides `extra_cost` field and base `_cal_price` |
