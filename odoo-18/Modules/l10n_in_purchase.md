...
GST treatment on vendor bills determines the applicable tax (intra-state CGST+SGST vs inter-state IGST) via fiscal positions from [Modules/l10n_in](l10n_in.md).
