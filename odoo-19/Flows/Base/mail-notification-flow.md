...
43. bus.bus.sendone(channel='[[Modules/mail]], notification_type, message_dict')
...
- [[Modules/mail]] — Mail module reference
- [[Modules/mail]] — Activity module reference
- [[Flows/Sale/quotation-to-sale-order-flow]] — Sale order notification side effects
- [[Flows/HR/leave-request-flow]] — Leave request notification side effects
- [[Flows/Helpdesk/ticket-creation-flow]] — Helpdesk notification side effects
- [[Flows/Website/website-sale-flow]] — Website sale confirmation email
- [[Modules/mail]] — Email configuration guide
