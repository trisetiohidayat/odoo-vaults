...
- [Modules/event](odoo-18/Modules/event.md) — Base event management
- [Modules/website_event](odoo-18/Modules/website_event.md) — Event on website
- [Modules/website_event_track_live](odoo-18/Modules/website_event_track_live.md) — Live streaming integration
- [Modules/website_event_track_quiz](odoo-18/Modules/website_event_track_quiz.md) — Quiz during tracks
- [Modules/website_event_track_live_quiz](odoo-18/Modules/website_event_track_live_quiz.md) — Combined live + quiz
