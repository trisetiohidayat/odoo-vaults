...
- [[Modules/Account]] — Core accounting: journal entries, move posting, tax engine, audit trail
- [[Modules/l10n_din5008]] — German document layout: paperformat, letterhead standard
- [[Modules/Stock]] — Inventory valuation, stock moves, stock accounts
- [[Patterns/Security Patterns]] — GoBD compliance, ir.rule, ACL CSV, audit trail
- [[New Features/API Changes]] — Odoo 18→19 changes in l10n localization framework
- [[Flows/Cross-Module/purchase-stock-account-flow]] — PO→Receipt→Vendor Bill with German VAT
