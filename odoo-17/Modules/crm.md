...
- [Modules/sale](sale.md) — Opportunity to Sale order conversion
- [Modules/project](project.md) — CRM case to project/task conversion
- [Modules/mail](mail.md) — Mail threading and activity scheduling
- [Patterns/Workflow Patterns](Workflow Patterns.md) — Stage-based pipeline workflows
- [Modules/mrp](mrp.md) — Manufacturing relationship (for quotations)
