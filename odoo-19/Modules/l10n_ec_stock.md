...
Ecuador Stock module extends the base Ecuadorian accounting localization (`l10n_ec`) with stock/inventory-specific configurations. Integrates Ecuadorian chart of accounts with [Modules/Stock](Stock.md) module inventory valuation.
...
| [Modules/Stock](Stock.md) | Inventory management module |
...
- [Modules/l10n_ec_sale](l10n_ec_sale.md) - Ecuador sale extensions
- [Modules/l10n_ec_stock](l10n_ec_stock.md) - Ecuador stock (this module)
