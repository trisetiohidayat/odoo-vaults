...
level: 1
related_flows:
  - "[Flows/HR/attendance-checkin-flow](odoo-19/Flows/HR/attendance-checkin-flow.md)"
...
- [Modules/resource](odoo-18/Modules/resource.md) — Resource module reference
- [Modules/hr_attendance](odoo-18/Modules/hr_attendance.md) — HR attendance module reference
- [Flows/HR/attendance-checkin-flow](odoo-19/Flows/HR/attendance-checkin-flow.md) — Check-in flow details
- [Flows/HR/leave-request-flow](odoo-19/Flows/HR/leave-request-flow.md) — Leave request flow using calendar
- [Business/HR/quickstart-employee-setup](odoo-19/Business/HR/quickstart-employee-setup.md) — Employee onboarding including resource setup
