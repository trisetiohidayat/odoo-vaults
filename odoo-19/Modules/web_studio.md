...
- [Modules/web_studio](odoo-19/Modules/web_studio.md) -- `web_enterprise` dependency
- [Core/BaseModel](odoo-18/Core/BaseModel.md) -- ORM foundation (StudioMixin inherits BaseModel)
...
- [Core/Fields](odoo-18/Core/Fields.md) -- field types including custom `x_` fields
