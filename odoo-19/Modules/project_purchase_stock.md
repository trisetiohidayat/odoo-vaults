...
| Module | Role |
|---|---|
| [Modules/project_purchase](project_purchase.md) | Adds `project_id` field to `purchase.order`; enables purchase cost tracking in project profitability |
| [Modules/project_stock](project_stock.md) | Adds `project_id` field to `stock.picking`; adds project picking action menus |
| [Modules/purchase_stock](purchase_stock.md) | Manages PO-to-receipt flow; base `_prepare_picking` and buy-rule procurement |
| [Modules/Stock](Stock.md) | Core stock module; `stock.rule` base model; `stock.picking` base model |
| [Modules/Purchase](Purchase.md) | Core purchase module; `purchase.order` base model |
