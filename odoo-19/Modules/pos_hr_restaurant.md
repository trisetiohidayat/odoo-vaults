...
- [Modules/pos_hr](odoo-17/Modules/pos_hr.md) — Employee login and session management
- [Modules/pos_restaurant](odoo-18/Modules/pos_restaurant.md) — Restaurant floor plan and table management
- [Modules/point_of_sale](odoo-18/Modules/point_of_sale.md) — POS base module
- [Modules/pos_restaurant_stripe](odoo-18/Modules/pos_restaurant_stripe.md) — Stripe tipping bridge
- [Modules/pos_restaurant_adyen](odoo-18/Modules/pos_restaurant_adyen.md) — Adyen tipping bridge
- [Modules/pos_restaurant_loyalty](odoo-18/Modules/pos_restaurant_loyalty.md) — Loyalty bridge
