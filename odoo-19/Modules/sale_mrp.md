...
- [Modules/mrp](odoo-18/Modules/mrp.md) — Manufacturing orders, BOMs, work orders
- [Modules/sale_stock](odoo-18/Modules/sale_stock.md) — Sale + Stock integration (procurement groups, MTO)
- [Modules/stock](odoo-18/Modules/stock.md) — Stock moves, quant, picking
- [Modules/account](odoo-18/Modules/account.md) — Invoice, COGS, Anglo-Saxon valuation
- [Core/API](odoo-18/Core/API.md) — @api.depends, @api.onchange, computed fields
