...
Provides a pre-configured [Modules/spreadsheet_dashboard](spreadsheet_dashboard.md) template combining sales order data with timesheet billing metrics. Shows revenue recognized from time-and-materials sales alongside project time tracking.
...
- [Modules/sale_timesheet](sale_timesheet.md) — Timesheet-based billing on sales orders
- [Modules/hr_timesheet](hr_timesheet.md) — Timesheet entry
