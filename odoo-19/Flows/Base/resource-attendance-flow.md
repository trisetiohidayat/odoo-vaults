...
level: 1
related_flows:
  - "[[Flows/HR/attendance-checkin-flow]]"
...
- [[Modules/resource]] — Resource module reference
- [[Modules/hr_attendance]] — HR attendance module reference
- [[Flows/HR/attendance-checkin-flow]] — Check-in flow details
- [[Flows/HR/leave-request-flow]] — Leave request flow using calendar
- [[Business/HR/quickstart-employee-setup]] — Employee onboarding including resource setup
