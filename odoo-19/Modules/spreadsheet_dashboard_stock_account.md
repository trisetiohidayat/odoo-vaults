...
Provides a pre-configured [Modules/spreadsheet_dashboard](spreadsheet_dashboard.md) template for warehouse managers and controllers to monitor inventory levels, valuation, and stock-valuation accounting entries.
...
- [Modules/stock_account](stock_account.md) — Stock valuation and accounting entries
- [Modules/Stock](Stock.md) — Inventory management base
