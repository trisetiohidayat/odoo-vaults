...
Provides the core barcode parsing engine used by [[Modules/stock]], [[Modules/point_of_sale]], and other inventory/nomenclature modules. It defines barcode nomenclatures (sets of ordered rules), individual barcode rules, a form-level barcode event mixin, and GS1 / EPC RFID URI parsing support.
...
- [[Modules/stock]] — `stock.picking`, `stock.inventory` inherit the barcode event mixin
- [[Modules/point_of_sale]] — POS uses `BarcodeParser` in JavaScript for product identification
- [[Modules/product]] — Product `barcode` field is the primary lookup target
- [[Core/Fields]] — Barcode field type in Odoo
- [[Patterns/Workflow Patterns]] — State machine usage in picking confirmation

## See Also

- [[Modules/stock]]
- [[Modules/point_of_sale]]
- [[Modules/stock_account]] (inventory valuation via stock.quant)
- [[Core/Fields]] (barcode field type in Odoo)
- [[Patterns/Workflow Patterns]] (state machine usage in picking confirmation)
