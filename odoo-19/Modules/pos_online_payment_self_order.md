...
- [Modules/pos_online_payment](pos_online_payment.md) — Base online payment handling
- [Modules/payment_authorize](payment_authorize.md) — Authorize.Net payment provider
