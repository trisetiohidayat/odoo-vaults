...
This module extends [Modules/l10n_ro_edi_stock](l10n_ro_edi_stock.md) to support **batch picking** operations for the Romanian e-Transport system. It enables consolidated e-Transport reporting for multiple stock pickings grouped into a single batch operation.

## Dependencies

| Module | Purpose |
|--------|---------|
| [Modules/l10n_ro_edi_stock](l10n_ro_edi_stock.md) | Base e-Transport (ANAF API utilities) |
| [Modules/stock_picking_batch](stock_picking_batch.md) | Batch picking management |
...
| [Modules/l10n_ro_edi](l10n_ro_edi.md) | ANAF e-Factura |
| [Modules/l10n_ro_edi_stock](l10n_ro_edi_stock.md) | Base e-Transport for single pickings |
| [Modules/stock_picking_batch](stock_picking_batch.md) | Batch picking management |
...
- Uses the same ANAF e-Transport API as [Modules/l10n_ro_edi_stock](l10n_ro_edi_stock.md)
...
- [Modules/l10n_ro_edi_stock](l10n_ro_edi_stock.md) - e-Transport for single pickings
- [Modules/l10n_ro_edi](l10n_ro_edi.md) - ANAF e-Factura
