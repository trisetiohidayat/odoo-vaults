...
## Country
[[Modules/Account|Switzerland]] 🇨🇭 (non-EU)
...
## Chart of Accounts
Inherits from [[Modules/Account|l10n_ch]] (Swiss chart).

## Tax Structure
Inherits from [[Modules/Account|l10n_ch]] (Swiss VAT: 8.1% standard, 2.6% reduced, 0% exlude).

## Fiscal Positions
Inherits from [[Modules/Account|l10n_ch]].
