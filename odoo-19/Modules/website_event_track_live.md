...
- [Modules/website_event_track](odoo-18/Modules/website_event_track.md) — Base event track module (parent of this module)
- [Modules/website_event_track_quiz](odoo-18/Modules/website_event_track_quiz.md) — Quiz module layered on top of event tracks
- [Modules/event](odoo-18/Modules/event.md) — Event management core
- [Core/Fields](odoo-18/Core/Fields.md) — Char, Boolean, Computed field patterns
