...
The module establishes the foundation for Malaysia's Goods and Services Tax (GST) / Sales and Service Tax (SST) reporting structures and integrates with the [Modules/l10n_my_edi](l10n_my_edi.md) module for e-invoicing.
...
| [Modules/account_tax_python](account_tax_python.md) | Python-based tax computation |
...
- [Modules/l10n_my_edi](l10n_my_edi.md) - Malaysia e-invoicing (MyInvois)
- [Modules/l10n_my_edi_pos](l10n_my_edi_pos.md) - POS e-invoicing integration
- [Modules/l10n_my_ubl_pint](l10n_my_ubl_pint.md) - Malaysia UBL PINT format for Peppol
