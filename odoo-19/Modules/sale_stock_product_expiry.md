...
- [Modules/Stock](Stock.md) -- Stock quants, lots, and expiration tracking
- [Modules/Sale](Sale.md) -- Sale order and stock integration
- [Modules/Product](Product.md) -- Product expiration settings
