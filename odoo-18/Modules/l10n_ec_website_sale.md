...
## Overview
Bridge module connecting [Modules/l10n_ec](odoo-18/Modules/l10n_ec.md) with `website_sale`. Adds Ecuadorian-specific fields to the eCommerce checkout: RUC, identification types, and payment methods required for e-invoicing compliance. Payment method data includes Ecuador-specific payment types (credit cards, debit cards, cash, etc.).
