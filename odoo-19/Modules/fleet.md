...
- [Modules/account_fleet](account_fleet.md) — Accounting integration for fleet costs
- [Modules/HR](HR.md) — HR module (driver management, plan_to_change flags)
- [Modules/mail](mail.md) — Mail and activity tracking
- [Core/API](API.md) — @api.depends, @api.onchange patterns
- [Patterns/Workflow Patterns](Workflow Patterns.md) — State machine patterns (e.g., contract states)

---

## See Also

- [Modules/Stock](Stock.md) — warehouse/location tracking
- [Modules/Purchase](Purchase.md) — vendor contracts
- [Modules/Account](Account.md) — accounting entries from fleet costs
