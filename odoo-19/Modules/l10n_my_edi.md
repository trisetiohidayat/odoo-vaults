...
The module depends on [Modules/l10n_my_ubl_pint](l10n_my_ubl_pint.md) for the underlying UBL format and reuses fields defined there.

## Dependencies

| Module | Purpose |
|--------|---------|
| [Modules/l10n_my](l10n_my.md) | Base Malaysian accounting localization |
| [Modules/l10n_my_ubl_pint](l10n_my_ubl_pint.md) | UBL PINT format for e-invoice generation |
| [Modules/account_edi_proxy_client](account_edi_proxy_client.md) | EDI proxy client for API communication |
...
- [Modules/l10n_my](l10n_my.md) - Core Malaysian accounting
- [Modules/l10n_my_ubl_pint](l10n_my_ubl_pint.md) - UBL PINT format
- [Modules/l10n_my_edi_pos](l10n_my_edi_pos.md) - POS e-invoicing integration
