...
- [[Modules/pos_event]] — POS event integration (pos_order_id, pos_order_line_id on registration)
- [[Modules/pos_sale]] — POS sale order linking (sale_order_line_id on POS lines)
- [[Modules/event_sale]] — SO-to-registration bridge (sale_order_id on registration)
- [[Modules/event]] — Base event module (event.registration model, state machine)
- [[Modules/point_of_sale]] — POS base (pos.order, pos.order.line)
- [[Modules/pos_sale_margin]] — Another POS link module (sale.report margin)
