...
See [Modules/portal](portal.md) for full documentation on the portal controller. Key routes used by the rating flow:
...
- [Core/API](API.md) - API decorators used in rating models
- [Modules/mail](mail.md) - Mail thread and message system integration
- [Modules/portal](portal.md) - Portal controller for public rating access
- [Modules/helpdesk](helpdesk.md) - Example module using rating functionality
- [Modules/project](Project.md) - Example of parent-level rating aggregation
