...
- [Modules/pos_pine_labs](pos_pine_labs.md) — Pine Labs terminal integration
- [Modules/pos_self_order_razorpay](pos_self_order_razorpay.md) — Razorpay terminal in self-order (polling, INR decimal)
- [Modules/pos_self_order_adyen](pos_self_order_adyen.md) — Adyen terminal in self-order (push webhook, multi-currency)
- [Modules/pos_self_order_qfpay](pos_self_order_qfpay.md) — QFPay terminal in self-order (webhook, HKD)
