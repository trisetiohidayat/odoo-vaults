...
Related: [Modules/auth_totp](odoo-18/Modules/auth_totp.md) (base TOTP), [Modules/auth_totp_mail_enforce](odoo-17/Modules/auth_totp_mail_enforce.md) (enforcement), [Modules/auth_totp_portal](odoo-17/Modules/auth_totp_portal.md) (portal 2FA), [Core/API](odoo-18/Core/API.md) (security notifications)
---
...
def action_open_my_account_settings(self):
    action = {
        ...
        "res_model": "res.users",
        "views": [self.env.ref('auth_totp_mail.res_users_view_form').id, "form"](self.env.ref('auth_totp_mail.res_users_view_form').id,-"form".md),
        "res_id": self.id,
    }
    return action
```
