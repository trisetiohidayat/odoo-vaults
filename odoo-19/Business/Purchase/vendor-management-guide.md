...
|------|------|-------------|
| 🔀 Technical Flow | [Flows/Purchase/purchase-order-creation-flow](purchase-order-creation-flow.md) | RFQ → PO confirmation |
| 🔀 Technical Flow | [Flows/Purchase/purchase-order-receipt-flow](purchase-order-receipt-flow.md) | PO → receipt |
| 🔀 Technical Flow | [Flows/Purchase/purchase-to-bill-flow](purchase-to-bill-flow.md) | Receipt → vendor bill |
| 📖 Module Reference | [Modules/Purchase](Purchase.md) | Complete model reference |
...
| Type | Link | Description |
|------|------|-------------|
| 🔀 PO Creation Flow | [Flows/Purchase/purchase-order-creation-flow](purchase-order-creation-flow.md) | RFQ → PO confirmation |
| 🔀 Receipt Flow | [Flows/Purchase/purchase-order-receipt-flow](purchase-order-receipt-flow.md) | PO → goods received |
| 🔀 Purchase-to-Bill | [Flows/Purchase/purchase-to-bill-flow](purchase-to-bill-flow.md) | Receipt → vendor bill |
| 📖 Module Reference | [Modules/Purchase](Purchase.md) | Complete model reference |
