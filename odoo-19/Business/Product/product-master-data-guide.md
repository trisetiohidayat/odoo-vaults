...
related_flows:
  - "[Flows/Product/product-creation-flow](odoo-19/Flows/Product/product-creation-flow.md)"
...
|------|------|-------------|
| 🔀 Technical Flow | [Flows/Product/product-creation-flow](odoo-19/Flows/Product/product-creation-flow.md) | Full method chain and branching logic |
| 🔀 Technical Flow | [Flows/Product/pricelist-computation-flow](odoo-19/Flows/Product/pricelist-computation-flow.md) | Pricelist price computation for sales |
| 📖 Module Reference | [Modules/product](odoo-18/Modules/product.md) | Complete field and method reference |
| 📋 Related Guide | [Flows/Stock/receipt-flow](odoo-17/Flows/Stock/receipt-flow.md) | Stock receipt flow using products |
| 🔧 Configuration | [Modules/Product](odoo-18/Modules/product.md) | Accounting-related product settings |
...
| Type | Link | Description |
|------|------|-------------|
| 🔀 Technical Flow | [Flows/Product/product-creation-flow](odoo-19/Flows/Product/product-creation-flow.md) | Full method chain for product create |
| 🔀 Technical Flow | [Flows/Product/pricelist-computation-flow](odoo-19/Flows/Product/pricelist-computation-flow.md) | Price computation on sale order lines |
| 📖 Module Reference | [Modules/product](odoo-18/Modules/product.md) | Complete product model reference |
| 📋 Related Guide | [Flows/Stock/receipt-flow](odoo-17/Flows/Stock/receipt-flow.md) | Stock receipt workflow |
| 📋 Related Guide | [Flows/Purchase/purchase-order-creation-flow](odoo-19/Flows/Purchase/purchase-order-creation-flow.md) | Purchase order creation |
