...
## Overview
Extends [Modules/l10n_my_edi](odoo-18/Modules/l10n_my_edi.md) with three enhanced capabilities:
...
## EDI Format / Standard
Same as [Modules/l10n_my_edi](odoo-18/Modules/l10n_my_edi.md) — MyInvois UBL 2.1 format.
