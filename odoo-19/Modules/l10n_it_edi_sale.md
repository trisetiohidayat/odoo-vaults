...
## Related
- [Modules/l10n_it_edi](l10n_it_edi.md) — Core Italian SDI/FatturaPA e-invoicing
- [Modules/Sale](Sale.md) — Base sale order module
- [Modules/l10n_it_edi_doi](l10n_it_edi_doi.md) — Italian Declaration of Intent (scambi_elenconi)
