...
- [[Modules/HR]] - Core HR module (dependency)
- [[Modules/Resource]] - Resource scheduling
- [[Modules/Mail]] - Activity and notification system
- [[Modules/documents]] - Document management for certificates
- [[Modules/hr_recruitment]] - Applicant tracking (skill matching)
- [[Modules/hr_recruitment_skills]] - Skills assessment for recruitment
- [[Modules/hr_skills]] - Skills assessment in events
- [[Modules/hr_skills]] - Skills from e-learning (integrates with slides)
- [[Modules/hr_skills]] - Skills from surveys/certifications

---

## See Also

- [[Core/Fields]] - Field types used in skills
- [[Core/API]] - @api.depends, @api.constrains decorators
- [[Core/BaseModel]] - Model foundation and inheritance
- [[Patterns/Security Patterns]] - Access control implementation
- [[Modules/HR]] - Employee model extension
- [[Modules/hr_recruitment]] - Job position model
