...
- [[Modules/event]] — Base event module (`event.event`, `event.registration`, `event.event.ticket`)
- [[Modules/event_product]] — Product-event linking (`service_tracking = 'event'`, `product_id` on tickets)
- [[Modules/sale]] — Sale order flow (`sale.order`, `sale.order.line`)
- [[Modules/website_event_sale]] — E-commerce integration (depends on `event_sale`)
- [[Modules/website_event]] — Event website pages and registration forms
