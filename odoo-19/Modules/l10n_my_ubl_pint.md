...
This module defines the XML schema and formatting rules. The actual API communication with MyInvois is handled by [[Modules/l10n_my_edi]].

## Dependencies

| Module | Purpose |
|--------|---------|
| [[Modules/account_edi_ubl_cii]] | UBL/CII invoice format framework |
...
- [[Modules/l10n_my_edi]] - MyInvois e-invoicing (uses this format)
- [[Modules/account_edi_ubl_cii]] - UBL/CII framework
- [[Modules/account_edi_proxy_client]] - EDI proxy for Peppol
