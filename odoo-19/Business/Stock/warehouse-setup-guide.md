...
|------|------|-------------|
| 🔀 Technical Flow | [Flows/Stock/receipt-flow](odoo-17/Flows/Stock/receipt-flow.md) | Receipt process |
| 🔀 Technical Flow | [Flows/Stock/delivery-flow](odoo-19/Flows/Stock/delivery-flow.md) | Delivery process |
| 📖 Module Reference | [Modules/Stock](odoo-18/Modules/stock.md) | Complete model reference |
...
| Type | Link | Description |
|------|------|-------------|
| 🔀 Receipt Flow | [Flows/Stock/receipt-flow](odoo-17/Flows/Stock/receipt-flow.md) | Incoming receipt process |
| 🔀 Delivery Flow | [Flows/Stock/delivery-flow](odoo-19/Flows/Stock/delivery-flow.md) | Outgoing delivery process |
| 🔀 Picking Actions | [Flows/Stock/picking-action-flow](odoo-19/Flows/Stock/picking-action-flow.md) | confirm→assign→done |
| 📖 Module Reference | [Modules/Stock](odoo-18/Modules/stock.md) | Complete model reference |
