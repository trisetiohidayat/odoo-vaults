...
- [Modules/mail](mail.md) -- Core messaging; snailmail extends mail.message, mail.thread, and mail.notification.
- [Modules/sms](sms.md) -- Parallel notification channel; snailmail and SMS are alternative channels for the same document.
