...
- [Modules/mrp_subcontracting](mrp_subcontracting.md) — Core subcontracting MO management; this module is the direct parent
- [Modules/stock_dropshipping](stock_dropshipping.md) — Core dropship routing; provides `route_drop_shipping` and dropship rule logic
- [Modules/mrp_subcontracting_purchase](mrp_subcontracting_purchase.md) — Subcontracting PO to subcontractor (no dropship)
- [Modules/mrp_subcontracting_account](mrp_subcontracting_account.md) — Subcontracting valuation and bill processing
- [Modules/Stock](Stock.md) — `stock.move`, `stock.picking`, `stock.rule`, `stock.warehouse`, `stock.location`
- [Modules/Purchase](Purchase.md) — `purchase.order`, `purchase.order.line`
