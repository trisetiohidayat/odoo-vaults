...
- [[Modules/project_account]] — Parent project profitability and analytic integration
- [[Modules/hr_expense]] — Employee expense management, states, approval workflow
- [[Modules/project_purchase]] — Purchase orders in project profitability (shares double-count prevention logic)
- [[Modules/Stock]] — Inventory costs in project profitability (parallel pattern)
