...
- [Modules/Account](Account.md) — Core accounting: journal entries, move posting, tax engine, audit trail
- [Modules/l10n_din5008](l10n_din5008.md) — German document layout: paperformat, letterhead standard
- [Modules/Stock](Stock.md) — Inventory valuation, stock moves, stock accounts
- [Patterns/Security Patterns](Security Patterns.md) — GoBD compliance, ir.rule, ACL CSV, audit trail
- [New Features/API Changes](API Changes.md) — Odoo 18→19 changes in l10n localization framework
- [Flows/Cross-Module/purchase-stock-account-flow](purchase-stock-account-flow.md) — PO→Receipt→Vendor Bill with German VAT
