...
Hungary uses the **Online Számla** (Online Invoice) system — mandatory real-time invoice reporting to NAV (Nemzeti Adó- és Vámhivatal). E-invoicing is required for B2G transactions. EDI handled by `l10n_hu_edi` (separate module). See `[[Modules/l10n_hu_edi]]`.
