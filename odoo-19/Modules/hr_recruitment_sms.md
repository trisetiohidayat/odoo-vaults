...
## Related
- [Modules/hr_recruitment](odoo-17/Modules/hr_recruitment.md) — Recruitment base
- [Modules/sms](odoo-18/Modules/sms.md) — SMS module
- [Modules/hr_recruitment_skills](odoo-18/Modules/hr_recruitment_skills.md) — Recruitment + Skills
