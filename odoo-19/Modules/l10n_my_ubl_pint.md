...
This module defines the XML schema and formatting rules. The actual API communication with MyInvois is handled by [Modules/l10n_my_edi](odoo-18/Modules/l10n_my_edi.md).

## Dependencies

| Module | Purpose |
|--------|---------|
| [Modules/account_edi_ubl_cii](odoo-18/Modules/account_edi_ubl_cii.md) | UBL/CII invoice format framework |
...
- [Modules/l10n_my_edi](odoo-18/Modules/l10n_my_edi.md) - MyInvois e-invoicing (uses this format)
- [Modules/account_edi_ubl_cii](odoo-18/Modules/account_edi_ubl_cii.md) - UBL/CII framework
- [Modules/account_edi_proxy_client](odoo-18/Modules/account_edi_proxy_client.md) - EDI proxy for Peppol
