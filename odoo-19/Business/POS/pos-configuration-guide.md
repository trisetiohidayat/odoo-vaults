...
|------|------|-------------|
| Technical Flow | [Flows/POS/pos-session-flow](odoo-19/Flows/POS/pos-session-flow.md) | Full session lifecycle method chain |
| Technical Flow | [Flows/POS/pos-order-to-invoice-flow](odoo-19/Flows/POS/pos-order-to-invoice-flow.md) | Order-to-invoice method chain |
| Module Reference | [Modules/pos](odoo-19/Modules/pos.md) | Complete POS model and field reference |
| Configuration | [Modules/pos](odoo-19/Modules/pos.md) → Payment Methods | Payment method setup details |
| Related Guide | [Business/Account/chart-of-accounts-guide](odoo-19/Business/Account/chart-of-accounts-guide.md) | Accounting journals and accounts |
...
| Type | Link | Description |
|------|------|-------------|
| Technical Flow | [Flows/POS/pos-session-flow](odoo-19/Flows/POS/pos-session-flow.md) | Full session lifecycle — for developers |
| Technical Flow | [Flows/POS/pos-order-to-invoice-flow](odoo-19/Flows/POS/pos-order-to-invoice-flow.md) | Order-to-invoice method chain |
| Module Reference | [Modules/pos](odoo-19/Modules/pos.md) | Complete POS model, field, and method reference |
| Module Reference | [Modules/Account](odoo-18/Modules/account.md) | account.move, journal configuration |
| Module Reference | [Modules/res.partner](odoo-19/Modules/res.partner.md) | Partner model for customer management |
...
| Accounting Guide | [Business/Account/chart-of-accounts-guide](odoo-19/Business/Account/chart-of-accounts-guide.md) | Journal and account setup |
