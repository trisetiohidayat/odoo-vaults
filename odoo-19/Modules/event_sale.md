...
- [Modules/event](odoo-18/Modules/event.md) — Base event module (`event.event`, `event.registration`, `event.event.ticket`)
...
- [Modules/sale](odoo-18/Modules/sale.md) — Sale order flow (`sale.order`, `sale.order.line`)
- [Modules/website_event_sale](odoo-18/Modules/website_event_sale.md) — E-commerce integration (depends on `event_sale`)
- [Modules/website_event](odoo-18/Modules/website_event.md) — Event website pages and registration forms
