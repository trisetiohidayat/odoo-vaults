...
## Overview
Bridge module connecting [Modules/l10n_br](odoo-18/Modules/l10n_br.md) with the `sale` module. Adds Brazilian-specific views and portal templates for sale orders and invoices. Auto-installs with sale and l10n_br.
