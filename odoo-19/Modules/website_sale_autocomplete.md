...
- [[Modules/website_sale]] — E-commerce checkout and address form
- [[Modules/google_address_autocomplete]] — Base Google address autocomplete module (`googlePlacesSession`, `AutoCompleteController`, `FIELDS_MAPPING`, session token handling)
- [[Modules/partner_autocomplete]] — Partner contact auto-fill using different providers (not Google)
- [[Modules/base_geolocalize]] — Geocoding from partner address
- [[Modules/website_sale_delivery]] — Delivery method selection (depends on correct country/state being set by autocomplete)
