...
- [[Modules/stock_landed_costs]] — Base landed costs module (`stock.landed.cost` model)
- [[Modules/mrp_subcontracting]] — Subcontracting manufacturing orders and pickings
- [[Modules/mrp_landed_costs]] — MRP-specific landed cost views (adds `mrp_production_ids` field)
- [[Modules/stock_account]] — Valuation and landed cost accounting integration
