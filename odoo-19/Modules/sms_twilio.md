...
- [Modules/sale_margin](sale_margin.md) - Margin calculation (another CE extension module)
- [Core/API](API.md) - External API patterns
- [Tools/ORM Operations](ORM Operations.md) - SMS sending via ORM
