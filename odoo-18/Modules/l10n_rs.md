...
Serbian SAF-T (JIS — Jedinstveni Informacioni Sistem) format. Turnover date field enables correct VAT period assignment in SAF-T exports. See also [[Modules/l10n_rs_edi|l10n_rs_edi]] for e-invoice (eFaktura) support.
