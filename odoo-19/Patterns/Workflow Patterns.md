...
> **📖 Deep Dive:** Untuk method chain lengkap dengan branching, lihat [Flows/TEMPLATE-flow](TEMPLATE-flow.md).
...
- [Flows/TEMPLATE-flow](TEMPLATE-flow.md) — Full flow document template with branching
- [Core/API](API.md) — @api.depends, @api.onchange decorator patterns
- [Core/BaseModel](BaseModel.md) — Model foundation, inheritance
- [Core/Exceptions](Exceptions.md) — UserError, ValidationError, AccessError
- [Patterns/Security Patterns](Security Patterns.md) — State-based access control
