...
- [[Modules/website_sale_stock]] — Parent module providing base stock display on website
- [[Modules/sale_mrp]] — Sale order + BoM integration; provides `_get_bom_component_qty()`
- [[Modules/mrp]] — Manufacturing module; defines `is_kits`, phantom BoMs, `explode()`
- [[Modules/website_sale]] — Base eCommerce controller and variant system
- [[Modules/stock]] — Inventory management; provides `free_qty`, `stock.quant`
- [[Core/Fields]] — Field types used: computed Boolean (`is_kits`), Float (`free_qty`)
