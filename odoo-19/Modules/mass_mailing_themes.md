...
- [Modules/mass_mailing](mass_mailing.md) — Base module that provides the email designer and `mailing.mailing` model
- [Modules/website_sale_mass_mailing](website_sale_mass_mailing.md) — Integrates mass mailing themes with e-commerce
- [Modules/mass_mailing_crm](mass_mailing_crm.md) — CRM-specific mailing features
- [Modules/mass_mailing_sms](mass_mailing_sms.md) — SMS alongside email campaigns
