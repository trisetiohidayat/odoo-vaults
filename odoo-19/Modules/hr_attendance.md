...
- [[Modules/hr]] — Base employee model, barcode field, PIN field
- [[Modules/hr_work_entry]] — Work entries generated from attendances (integration point)
- [[Modules/hr_holidays]] — Time off tracking; absence detection creates technical attendances that interact with leave
- [[Modules/hr_timesheet]] — Timesheet entry; attendance data used for approval context
