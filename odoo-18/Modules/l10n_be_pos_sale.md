...
## Chart of Accounts
Inherits from [l10n_be](odoo-18/Modules/account.md).

## Tax Structure
Inherits from [l10n_be](odoo-18/Modules/account.md).

## Fiscal Positions
Intra-community fiscal position (`fiscal_position_template_3`) from [l10n_be](odoo-18/Modules/account.md): maps domestic Belgian VAT to 0% intra-community (reverse charge).
