...
- [Modules/iap_crm](iap_crm.md) — Base IAP CRM (reveal_id on crm.lead)
- [Modules/iap_mail](iap_mail.md) — IAP enrichment mail template base
- [Modules/crm_iap_enrich](crm_iap_enrich.md) — Separate module for email-domain-based lead enrichment
- [Modules/crm](CRM.md) — Base CRM model
