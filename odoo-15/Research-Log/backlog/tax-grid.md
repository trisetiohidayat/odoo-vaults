...
- Semua model Utama sudah terdokumentasi di [Modules/Account](odoo-18/Modules/account.md)
- Tax Grid sudah ada dedicated guide di [Business/Account/tax-grid-guide](odoo-15/Business/Account/tax-grid-guide.md)
