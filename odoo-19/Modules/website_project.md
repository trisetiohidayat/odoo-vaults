...
`website_project` bridges the [Modules/project](Project.md) and [Modules/website](website.md) modules. It enables two core workflows:
...
- [Modules/website](website.md) — Website builder, Form Builder, visitor tracking
- [Modules/project](Project.md) — Project and task models, portal templates
- [Modules/website_project](website_project.md) — Meeting-based project page integration on website
