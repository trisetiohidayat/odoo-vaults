...
Provides a pre-configured [Modules/spreadsheet_dashboard](spreadsheet_dashboard.md) template tailored for restaurant POS operators. Combines POS order data with restaurant-specific dimensions (floors, tables, courses) and employee attribution.
...
- [Modules/pos_restaurant](pos_restaurant.md) — Restaurant POS (floors, tables, splitbill)
- [Modules/pos_hr](pos_hr.md) — POS employee login
