...
- [Modules/product](odoo-18/Modules/product.md) — Product template, attribute lines, variant creation logic
- [Modules/sale_product_matrix](odoo-18/Modules/sale_product_matrix.md) — Sale order grid entry (primary consumer)
- [Modules/purchase_product_matrix](odoo-18/Modules/purchase_product_matrix.md) — Purchase order grid entry
- [Modules/sale_product_configurator](odoo-17/Modules/sale_product_configurator.md) — Standard single-variant configurator dialog
