...
|---------|------|-------------|
| [Modules/Project](odoo-18/Modules/project.md) | Module | Parent `project.project`, `project.task` models |
| [Modules/sms](odoo-18/Modules/sms.md) | Module | SMS template, composer, and delivery pipeline |
| [Modules/project](odoo-18/Modules/project.md) | Module | Email notification counterpart for project stages |
...
- [Modules/Project](odoo-18/Modules/project.md) — `project.project`, `project.task`, stage models
- [Modules/sms](odoo-18/Modules/sms.md) — `sms.template`, `_message_sms_with_template()`, delivery pipeline
- [Modules/project](odoo-18/Modules/project.md) — Email notification counterpart for project stages
- [Patterns/Security Patterns](odoo-18/Patterns/Security Patterns.md) — `ir.rule`, `perm_read`, sudo() patterns
- [Core/Fields](odoo-18/Core/Fields.md) — `Many2one` field types, `ondelete` behavior
- [Core/API](odoo-18/Core/API.md) — `@api.model_create_multi`, `write()` hook patterns
