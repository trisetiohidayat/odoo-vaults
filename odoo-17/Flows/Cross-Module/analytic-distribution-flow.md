...
## See Also
- [[Modules/analytic]] — `account.analytic.account`, `account.analytic.plan`
- [[Modules/account]] — `account.move.line`, `analytic_distribution` field
- [[Flows/Cross-Module/accounting-reconciliation-flow]] — reconciliation that may trigger CABA
- [[Flows/Sale/full-sale-to-cash-flow]] — sale with analytics end-to-end
- [[Flows/Purchase/full-purchase-to-payment-flow]] — purchase with analytics end-to-end
