...
## Overview
Bridge module that adds Argentine-specific requirements to the Point of Sale application. Depends on [Modules/l10n_ar](odoo-18/Modules/l10n_ar.md) and `point_of_sale`. Extends the POS session to load Argentine-specific reference data and partner records for the POS interface.
