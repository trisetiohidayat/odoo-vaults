...
## Overview
Bridge module adding Uruguayan requirements to the Point of Sale application. Depends on [Modules/l10n_uy](odoo-18/Modules/l10n_uy.md) and `point_of_sale`. Loads frontend assets for Uruguayan POS regulation compliance.
