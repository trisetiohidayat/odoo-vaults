...
- [[Modules/web]] — Base web module (dependency), provides `is_a_bot`, debug handling, session info
- [[Modules/website]] — Website builder, extends routing with page serving and fallback handling
- [[Core/HTTP Controller]] — HTTP routing and controllers architecture
- [[ir.http]] — Base HTTP routing model (in `odoo/addons/base`)
- [[Patterns/Inheritance Patterns]] — `_inherit` vs. `_inherits` for model extension patterns