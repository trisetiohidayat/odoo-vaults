...
- [Modules/web_studio](web_studio.md) -- `web_enterprise` dependency
- [Core/BaseModel](BaseModel.md) -- ORM foundation (StudioMixin inherits BaseModel)
...
- [Core/Fields](Fields.md) -- field types including custom `x_` fields
