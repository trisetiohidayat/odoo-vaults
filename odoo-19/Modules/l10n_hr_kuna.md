...
Croatia transitioned from the Kuna (HRK) to the Euro (EUR) on **January 1, 2023**. New implementations should use [[Modules/l10n_hr]] which is designed for EUR.
...
| Module | Relationship |
|--------|-------------|
| [[Modules/l10n_hr]] | **Recommended** - EUR-based current module |
| [[Modules/l10n_hr_edi]] | E-invoicing for current Croatian compliance |

## Migration Path

For companies still using Kuna:
1. Migrate to [[Modules/l10n_hr]] (EUR version)
2. Convert HRK balances to EUR using official conversion rate
3. Install [[Modules/l10n_hr_edi]] for full compliance
...
- [[Modules/l10n_hr]] - Current Croatian accounting with EUR
- [[Modules/l10n_hr_edi]] - Croatian e-invoicing
