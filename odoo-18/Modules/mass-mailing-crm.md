...
- [[Modules/CRM]] — base CRM module (`crm.lead`, UTM mixin)
- [[Modules/Mass Mailing Sale]] — sale order email marketing tracking
- [[Modules/crm-sms]] — CRM SMS integration
- [[Core/Fields]] — Many2one, computed fields, `store=True` behavior
