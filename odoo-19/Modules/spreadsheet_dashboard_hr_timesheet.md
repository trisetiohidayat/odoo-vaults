...
Provides a pre-configured [Modules/spreadsheet_dashboard](spreadsheet_dashboard.md) template for project managers and HR to visualize timesheet data — hours logged per employee, project, and task. Data is sourced from `account.analytic.line` records created by [Modules/hr_timesheet](hr_timesheet.md).
...
- [Modules/hr_timesheet](hr_timesheet.md) — Timesheet entry and project time tracking
