...
- [Modules/iap_crm](iap_crm.md) — IAP account integration and credit management
- [Modules/crm_iap_mine](crm_iap_mine.md) — Industry/role/seniority master data; `lead_vals_from_response()` helper
- [Modules/iap_mail](iap_mail.md) — `iap_mail.enrich_company` mail template for posting enrichment data
- [Modules/website_crm](website_crm.md) — Website contact form; used by the controller override
- [Modules/crm](CRM.md) — CRM base module
- [Core/API](API.md) — `@api.model`, `@api.constrains`, `@tools.ormcache` usage in this module
- [Patterns/Workflow Patterns](Workflow Patterns.md) — Cron-based batch pipeline pattern
