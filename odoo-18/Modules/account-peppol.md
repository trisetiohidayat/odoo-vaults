...
- [[Modules/account-edi]] — Core EDI infrastructure (document lifecycle, crons, format registry)
- [[Modules/Account]] — `account.move` base model
- [[Core/API]] — `@api.depends`, computed fields, constraints
- [[Patterns/Workflow Patterns]] — State machine pattern used throughout
