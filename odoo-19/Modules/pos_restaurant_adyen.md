...
- [Modules/pos_restaurant](pos_restaurant.md) — Restaurant POS base module
- [Modules/pos_adyen](pos_adyen.md) — Adyen terminal POS integration
- [Modules/payment_adyen](payment_adyen.md) — Adyen payment provider
- [Modules/pos_restaurant_stripe](pos_restaurant_stripe.md) — Stripe tipping bridge (for comparison)
