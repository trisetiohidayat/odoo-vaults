...
-> [Flows/HR/employee-creation-flow](employee-creation-flow.md) — hr.employee create + hr.version
-> [Flows/HR/employee-archival-flow](employee-archival-flow.md) — Archive/unarchive + subordinates
-> [Flows/HR/employee-transfer-flow](employee-transfer-flow.md) — Department change + approval
-> [Flows/HR/leave-request-flow](leave-request-flow.md) — Leave request lifecycle (hr_holidays)
-> [Flows/HR/attendance-checkin-flow](attendance-checkin-flow.md) — Check-in/check-out + overtime
-> [Flows/HR/contract-lifecycle-flow](contract-lifecycle-flow.md) — Contract create/renew/terminate
-> [Flows/HR/expense-request-flow](expense-request-flow.md) — Expense submit + approval + journal
-> [Flows/HR/recruitment-applicant-flow](recruitment-applicant-flow.md) — Applicant → hire → employee
-> [Flows/HR/timesheet-submission-flow](timesheet-submission-flow.md) — Timesheet + billing type branching
-> [Flows/HR/department-creation-flow](department-creation-flow.md) — Department + hierarchy + manager
-> [Flows/HR/job-position-flow](job-position-flow.md) — Job vacancy + applicant pipeline

### How-To Guides (Functional — Business)
-> [Business/HR/quickstart-employee-setup](quickstart-employee-setup.md) — Step-by-step employee creation
-> [Business/HR/leave-management-guide](leave-management-guide.md) — Leave management process

### Related Modules
-> [Modules/resource](resource.md) — resource.resource, resource.calendar
-> [Modules/mail](mail.md) — mail.thread, activity integration
-> [Patterns/Workflow Patterns](Workflow Patterns.md) — State machine pattern
